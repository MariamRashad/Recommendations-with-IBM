...
Makng a recommendation engine using ranked based, user-user based collaborative filtering, content based, and matrix factorization
...
the tasks for the project will be divided into the following tasks
